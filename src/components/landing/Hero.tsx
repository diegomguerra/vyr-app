  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-8 sm:py-12">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-sm bg-vyr-gray-800 border border-vyr-gray-700 mb-6 sm:mb-8">
          <span className="text-xs sm:text-sm text-vyr-gray-300 font-mono tracking-wider">COGNITIVE PERFORMANCE SYSTEM</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-10 sm:mb-16 px-4">
          <Link to="/login?signup=true" className="w-full sm:w-auto">
            <Button size="lg" className="w-full sm:w-auto bg-vyr-white hover:bg-vyr-gray-100 text-vyr-black px-8 sm:px-12 py-5 sm:py-7 text-base sm:text-lg rounded-sm group border-0 transition-all duration-300">
              Começar agora
          ...
          <a href="#sistema" className="w-full sm:w-auto">
            <Button size="lg" variant="outline" className="w-full sm:w-auto bg-transparent px-8 sm:px-10 py-5 sm:py-7 text-base sm:text-lg rounded-sm border-vyr-gray-600 text-vyr-gray-300 hover:bg-vyr-gray-800 hover:border-vyr-gray-500 hover:text-vyr-white">
              Conhecer o sistema
            </Button>
          </a>
        </div>
        ...
        <div className="inline-flex flex-col sm:flex-row items-stretch sm:items-center gap-0 rounded-sm bg-vyr-gray-800/60 backdrop-blur-sm border border-vyr-gray-700 overflow-hidden w-full sm:w-auto max-w-sm sm:max-w-none mx-auto">
          <div className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-sm bg-vyr-gray-700 flex items-center justify-center flex-shrink-0">
              <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 text-vyr-gray-300" />
            </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-sm bg-vyr-gray-700 flex items-center justify-center flex-shrink-0">
              <Activity className="w-5 h-5 sm:w-6 sm:h-6 text-vyr-gray-300" />
            </div>
            <div className="text-left">
          ...
          <div className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-sm bg-vyr-gray-700 flex items-center justify-center flex-shrink-0">
              <BarChart3 className="w-5 h-5 sm:w-6 sm:h-6 text-vyr-gray-300" />
            </div>
            <div className="text-left">
